...
def parsing(host):
    ...
    try:
        while True:
            ...
            if ip_headers[6] == 6: # tcp
                print(f"{packet_number}: received TCP packet\n")
                print(f"Source: {ip_source_address} Destination: {ip_destination_address}")
                ...
                print("Data Offset: ", tcp_headers[4]>>4)
                print("Flags: ")
                print(">>CEUAPRSF")
                ...
                print(f"{packet_number}: received UDP packet\n")
                print(f"Source: {ip_source_address} Destination: {ip_destination_address}")
